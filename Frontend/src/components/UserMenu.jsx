...
// Componente de avatar + dropdown + modal edición perfil.
export default function UserMenu() {
    ...
    useEffect(() => {
        if (editing) {
            ...
            setTimeout(() => {
                ...
                if (el) try { el.focus(); } catch { /* no-op */ }
            }, 50);
        }
    }, [editing]);
    ...
    return (
        <div className="position-relative">
            ...
            {/* Modal edición perfil (portal a body para evitar conflictos de stacking y eventos) */}
